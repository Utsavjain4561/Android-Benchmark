...
public class StressTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stressScore = (TextView) findViewById(R.id.stressScore);
        ...
        startbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final ComputeSHA myHash = new ComputeSHA(MESSAGE, "SHA-512");
                    ...
                    public void run() {
                        ...
                        handler.post(new Runnable() {
                            public void run() {
                                ...
                                stressScore.setText(Integer.toString(score));
    ...
    public void onBackPressed() {
        ...
        resultIntent.putExtra("stress-score",Integer.toString(score));
        setResult(StressTest.RESULT,resultIntent);
        finish();
        super.onBackPressed();
    }
}
